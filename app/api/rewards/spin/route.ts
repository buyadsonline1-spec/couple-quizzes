...
// app/api/giveaway/complete-action/route.ts, намеренно без изменений,
// чтобы у нас был один проверенный способ подтверждать личность
// Telegram-пользователя на сервере.

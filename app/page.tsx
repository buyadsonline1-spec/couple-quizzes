  ...
  switch (theme) {
    case "Быт":
      return [
        {
          id: "q1",
          text: "Для меня важно, чтобы дома было чисто и уютно.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Домашние обязанности лучше обсуждать заранее, а не делить спонтанно.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Меня радует, когда партнёр сам замечает, чем нужно помочь по дому.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Бытовые привычки сильно влияют на комфорт в отношениях.",
          options: scaleOptions,
        },
      ];
    ...
    case "Конфликты":
      return [
        {
          id: "q1",
          text: "Проблемы лучше обсуждать сразу, а не копить обиды.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Даже во время ссоры важно уважительно разговаривать друг с другом.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Для меня важно не просто помириться, а действительно понять друг друга.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "В отношениях нормально искать компромисс, а не доказывать, кто прав.",
          options: scaleOptions,
        },
      ];
    ...
    case "Ревность":
      return [
        {
          id: "q1",
          text: "Лёгкая ревность допустима, если она не переходит в контроль.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Доверие важнее постоянных проверок и подозрений.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Меня напрягает, когда партнёр флиртует с другими людьми даже в шутку.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Если в паре есть доверие, поводов для ревности становится меньше.",
          options: scaleOptions,
        },
      ];
    ...
    case "Границы":
      return [
        {
          id: "q1",
          text: "В отношениях важно уважать личные границы друг друга.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Мне важно, чтобы мои личные решения не контролировали без необходимости.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Даже в близких отношениях у каждого должно быть своё пространство.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Нарушение границ лучше обсуждать спокойно и прямо.",
          options: scaleOptions,
        },
      ];
    ...
    case "Понимание":
      return [
        {
          id: "q1",
          text: "Для меня важно чувствовать, что партнёр старается меня понять.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Мне легче в отношениях, когда со мной открыто делятся чувствами.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Я ценю, когда партнёр замечает моё настроение без лишних объяснений.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "В паре важно не только слушать, но и действительно слышать друг друга.",
          options: scaleOptions,
        },
      ];
    ...
    case "Романтика":
      return [
        {
          id: "q1",
          text: "Романтика помогает поддерживать тепло даже в долгих отношениях.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Мне нравятся маленькие знаки внимания без особого повода.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Для меня важны красивые слова, признания и нежность.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Свидания и совместные приятные моменты нужно устраивать регулярно.",
          options: scaleOptions,
        },
      ];
    ...
    case "Личное пространство":
      return [
        {
          id: "q1",
          text: "Мне важно иногда проводить время наедине с собой.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Наличие собственных интересов делает отношения здоровее.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Партнёрам не обязательно всё время быть вместе, чтобы быть близкими.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Я уважаю право партнёра на личное время и свои увлечения.",
          options: scaleOptions,
        },
      ];
    ...
    case "Время вместе":
      return [
        {
          id: "q1",
          text: "Для меня важно качественно проводить время вдвоём, а не просто быть рядом.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Совместные традиции делают пару ближе.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Мне нравится планировать общий отдых или дела заранее.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Общее время — один из главных способов укреплять отношения.",
          options: scaleOptions,
        },
      ];
    ...
    case "Роли":
      return [
        {
          id: "q1",
          text: "Ожидания друг от друга лучше обсуждать открыто, а не додумывать.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "В паре важно, чтобы оба чувствовали вклад друг друга в отношения.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Мне ближе партнёрство, где решения принимаются вместе.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Роли в отношениях должны строиться на удобстве пары, а не на чужих шаблонах.",
          options: scaleOptions,
        },
      ];
    ...
    case "Внешность":
      return [
        {
          id: "q1",
          text: "Мне важно, чтобы партнёр следил за собой и выглядел ухоженно.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Внешняя привлекательность влияет на романтический интерес в паре.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Мне приятно, когда партнёр старается выглядеть красиво и для меня тоже.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Ухоженность говорит о внимании к себе и отношениям.",
          options: scaleOptions,
        },
      ];
    ...
    case "Стиль":
      return [
        {
          id: "q1",
          text: "Стиль — это способ выражать себя и настроение.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Мне нравится, когда у партнёра есть свой вкус и ощущение стиля.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Внешний образ влияет на первое впечатление и притяжение.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Мне важно чувствовать себя красивой и уверенной рядом с партнёром.",
          options: scaleOptions,
        },
      ];
    ...
    case "Уход":
      return [
        {
          id: "q1",
          text: "Забота о себе — важная часть привлекательности и уверенности.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Мне важно, чтобы партнёр следил за своим здоровьем и состоянием.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Уход за собой — это не мелочь, а часть уважения к себе.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Мне приятно, когда рядом человек, который старается выглядеть и чувствовать себя хорошо.",
          options: scaleOptions,
        },
      ];
    ...
    case "Семья":
      return [
        {
          id: "q1",
          text: "Для меня важно заранее обсуждать взгляды на семью и будущее.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Хорошие отношения с семьёй партнёра могут влиять на комфорт пары.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Я считаю важным говорить о детях и серьёзных планах открыто.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Семейные ценности сильно влияют на совместимость в отношениях.",
          options: scaleOptions,
        },
      ];
    ...
    case "Финансы":
      return [
        {
          id: "q1",
          text: "Финансовые вопросы в паре нужно обсуждать честно и спокойно.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Мне важно понимать отношение партнёра к деньгам и тратам.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Совместные финансовые цели помогают чувствовать себя командой.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Деньги не должны быть табуированной темой в отношениях.",
          options: scaleOptions,
        },
      ];
    ...
    case "Доверие":
      return [
        {
          id: "q1",
          text: "Без доверия сложно построить по-настоящему близкие отношения.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Для меня важна честность даже в неприятных разговорах.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Мне спокойнее в отношениях, когда слова партнёра совпадают с поступками.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Доверие формируется постепенно, но его легко потерять.",
          options: scaleOptions,
        },
      ];
    ...
    case "Верность":
      return [
        {
          id: "q1",
          text: "Верность для меня — это не только отсутствие измены, но и уважение к отношениям.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Эмоциональная близость с другим человеком тоже может ранить партнёра.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Мне важно, чтобы в отношениях были ясные границы допустимого.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Открытость и уважение помогают избегать ситуаций, которые разрушают доверие.",
          options: scaleOptions,
        },
      ];
    ...
    case "Общение":
      return [
        {
          id: "q1",
          text: "Мне важно, чтобы с партнёром можно было говорить обо всём открыто.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Я ценю, когда меня внимательно слушают, а не перебивают.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Хорошее общение важнее, чем попытка всегда выглядеть идеально.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Честный разговор часто помогает решить проблему лучше, чем молчание.",
          options: scaleOptions,
        },
      ];
    ...
    case "Мечты":
      return [
        {
          id: "q1",
          text: "Мне важно делиться с партнёром своими мечтами и планами.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Поддержка целей друг друга делает отношения сильнее.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Я хочу, чтобы партнёр уважал мои личные амбиции.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Общие мечты помогают чувствовать, что вы движетесь в одну сторону.",
          options: scaleOptions,
        },
      ];
    ...
    case "Саморазвитие":
      return [
        {
          id: "q1",
          text: "Мне важно развиваться как личность даже внутри отношений.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Я ценю партнёра, который мотивирует меня становиться лучше.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "В здоровых отношениях оба человека растут, а не тормозят друг друга.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Мне важно, чтобы партнёр уважал мои цели и стремление к росту.",
          options: scaleOptions,
        },
      ];
    ...
    case "Еда":
      return [
        {
          id: "q1",
          text: "Совместные завтраки, ужины или перекусы создают ощущение близости.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Мне приятно готовить или выбирать еду вместе с партнёром.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Еда и маленькие гастро-ритуалы могут делать отношения теплее.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Мне нравится пробовать что-то новое вместе с любимым человеком.",
          options: scaleOptions,
        },
      ];
    ...
    case "Отдых":
      return [
        {
          id: "q1",
          text: "Мне важно, чтобы отдых с партнёром приносил удовольствие нам обоим.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Совместные выходные помогают восстанавливать близость.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Мне нравится иногда выбираться куда-то вместе, даже без особого повода.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Хороший отдых в паре — это не формат, а ощущение комфорта рядом друг с другом.",
          options: scaleOptions,
        },
      ];
    ...
    case "Путешествия":
      return [
        {
          id: "q1",
          text: "Путешествия помогают лучше узнать друг друга.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Мне нравится идея совместных поездок и новых впечатлений вдвоём.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Даже маленькие поездки могут делать отношения ярче.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Мне важно, чтобы в путешествии учитывались желания обоих.",
          options: scaleOptions,
        },
      ];
    ...
    case "Окружение":
      return [
        {
          id: "q1",
          text: "Мне важно уважать друзей и окружение партнёра.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Отношение партнёра к моему кругу общения для меня тоже имеет значение.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Лишний контроль над окружением может портить отношения.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Здоровые отношения не требуют изоляции друг от друга и от других людей.",
          options: scaleOptions,
        },
      ];
    ...
    case "Ценности":
      return [
        {
          id: "q1",
          text: "Общие ценности сильно влияют на долговечность отношений.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Мне важно, чтобы в паре совпадали базовые взгляды на жизнь.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Даже при различиях важно уважать принципы друг друга.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Настоящая близость строится не только на чувствах, но и на общих смыслах.",
          options: scaleOptions,
        },
      ];
    ...
    case "Любовь":
      return [
        {
          id: "q1",
          text: "Любовь для меня — это не только эмоции, но и ежедневные поступки.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Мне важно чувствовать любовь не только словами, но и действиями.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Забота и внимание — важная часть любви для меня.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Любовь становится крепче, когда её регулярно показывают друг другу.",
          options: scaleOptions,
        },
      ];
    ...
    case "Поддержка":
      return [
        {
          id: "q1",
          text: "Мне важно, чтобы партнёр был рядом в трудные моменты.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Поддержка — это не всегда советы, иногда достаточно просто быть рядом.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Я особенно ценю, когда мои чувства не обесценивают.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "В крепких отношениях оба человека умеют поддерживать друг друга.",
          options: scaleOptions,
        },
      ];
    ...
    case "Будущее":
      return [
        {
          id: "q1",
          text: "Мне важно понимать, есть ли у отношений общее будущее.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Я считаю важным обсуждать планы заранее, а не избегать этой темы.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Совместные цели делают отношения более серьёзными и устойчивыми.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Мне спокойнее, когда мы с партнёром смотрим в одну сторону.",
          options: scaleOptions,
        },
      ];
    ...
    case "Идеал":
      return [
        {
          id: "q1",
          text: "Для меня идеальные отношения — это сочетание любви, уважения и комфорта.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Я верю, что в хорошей паре можно быть собой без страха осуждения.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Идеальная пара — не без ссор, а с умением их проживать.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Для меня идеальные отношения — это когда рядом спокойно, интересно и тепло.",
          options: scaleOptions,
        },
      ];
    ...
    case "Обязанности":
      return [
        {
          id: "q1",
          text: "Обязанности в паре лучше распределять честно и понятно.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Мне важно, чтобы ответственность не лежала только на одном человеке.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Забота о паре — это вклад обоих, а не чья-то личная обязанность.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Когда ожидания по обязанностям обсуждены, в отношениях меньше обид.",
          options: scaleOptions,
        },
      ];
    ...
    case "Хобби":
      return [
        {
          id: "q1",
          text: "Мне важно, чтобы у каждого были свои увлечения и интересы.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Общие хобби могут делать пару ещё ближе.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Я ценю, когда партнёр уважает мои интересы, даже если не разделяет их.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Мне нравится делиться любимыми занятиями с близким человеком.",
          options: scaleOptions,
        },
      ];
    ...
    case "Творчество":
      return [
        {
          id: "q1",
          text: "Мне нравится, когда в отношениях есть место вдохновению и необычным идеям.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Красивые, необычные жесты делают отношения ярче.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Мне приятно создавать особенные моменты вместе с партнёром.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Творческий подход помогает сохранять живость и интерес в отношениях.",
          options: scaleOptions,
        },
      ];
    ...
    default:
      return [
        {
          id: "q1",
          text: "Для меня в отношениях важно взаимное уважение.",
          options: scaleOptions,
        },
        {
          id: "q2",
          text: "Честность и открытость помогают строить доверие.",
          options: scaleOptions,
        },
        {
          id: "q3",
          text: "Поддержка друг друга делает пару сильнее.",
          options: scaleOptions,
        },
        {
          id: "q4",
          text: "Мне важно чувствовать себя спокойно и комфортно рядом с партнёром.",
          options: scaleOptions,
        },
      ];
  }

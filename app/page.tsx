...
const [rewardClaimed, setRewardClaimed] = useState(false);
  ...
  {
    text: "Я никогда не целовался(ась) под дождём",
    task: "если партнёр делал это — целует тебя в щёку",
  },
  {
  ...
  },
  {
    ...
    task: "если партнёр делал это — изображает это в лицах",
  },
  {
  ...
  {
    text: "Я никогда не знакомился(ась) в интернете первым(ой)",
    task: "если партнёр делал это — пишет тебе милое сообщение прямо сейчас",
  },
  {
    text: "Я никогда не удалял(а) сообщение перед отправкой в последний момент",
    task: "если партнёр делал это — говорит, что обычно хотел(а) отправить",
  },
  {
    text: "Я никогда не говорил(а) 'я в пути', ещё не выйдя из дома",
    task: "если партнёр делал это — делает виноватое лицо 10 секунд",
  },
  {
  ...
  },
  {
    ...
    task: "если партнёр делал это — признаётся, какой подарок был самым странным",
  },
  {
    text: "Я никогда не смотрел(а) романтический фильм и не плакал(а)",
    task: "если партнёр делал это — называет самый трогательный фильм",
  },
  {
  ...
  {
    text: "Я никогда не делал(а) вид, что всё нормально, когда был(а) обижен(а)",
    task: "если партнёр делал это — признаётся, как это обычно выглядит",
  },
  {
    text: "Я никогда не пересматривал(а) старые переписки",
    task: "если партнёр делал это — говорит, зачем он(а) это делал(а)",
  },
  {
    text: "Я никогда не мечтал(а) о свадьбе в деталях",
    task: "если партнёр делал это — описывает идеальную свадьбу за 20 секунд",
  },
  {
  ...
  {
    text: "Я никогда не влюблялся(ась) в учителя или преподавателя",
    task: "если партнёр делал это — признаётся, что именно нравилось",
  },
  {
    text: "Я никогда не писал(а) длинное сообщение и потом удалял(а) его",
  ...
  },
  {
    ...
    task: "если партнёр делал это — должен(на) внимательно выслушать тебя 30 секунд",
  },
  {
    text: "Я никогда не обижался(ась) из-за ерунды",
    task: "если партнёр делал это — честно признаётся в самой мелкой обиде",
  },
  {
    text: "Я никогда не делал(а) скриншот переписки",
    task: "если партнёр делал это — показывает свой самый innocent look",
  },
  {
    text: "Я никогда не говорил(а) 'мне всё равно', когда было не всё равно",
    task: "если партнёр делал это — говорит тебе 3 вещи, которые ему(ей) не всё равно",
  },
  {
    text: "Я никогда не хотел(а) сбежать с вечеринки домой",
    task: "если партнёр делал это — объясняет, что для него(неё) идеальный вечер",
  },
  {
    text: "Я никогда не стеснялся(ась) первым(ой) написать после ссоры",
    task: "если партнёр делал это — говорит, что помогло бы ему(ей) сделать это легче",
  },
  {
  ...
  {
    text: "Я никогда не врал(а) про свой возраст",
    task: "если партнёр делал это — рассказывает, когда и зачем",
  },
  {
    text: "Я никогда не опаздывал(а) на свидание больше чем на 30 минут",
    task: "если партнёр делал это — должен(на) извиниться максимально драматично",
  },
  {
    text: "Я никогда не терял(а) голову от симпатии к человеку",
    task: "если партнёр делал это — описывает это тремя словами",
  },
  {
  ...
  },
  {
    ...
    task: "если партнёр делал это — называет одно место, куда хотел(а) бы поехать с тобой",
  },
  {
    text: "Я никогда не мечтал(а) проснуться у моря",
    task: "если партнёр делал это — описывает это утро одной фразой",
  },
  {
  ...
  {
    text: "Я никогда не делал(а) коллаж или подборку фото",
    task: "если партнёр делал это — показывает руками форму сердечка",
  },
  {
    text: "Я никогда не притворялся(ась) спокойным(ой), когда нервничал(а)",
    task: "если партнёр делал это — делает глубокий вдох и улыбается тебе",
  },
  {
    text: "Я никогда не выбирал(а) одежду дольше часа",
    task: "если партнёр делал это — рассказывает свой самый сложный выбор",
  },
  {
  ...
  {
    text: "Я никогда не фантазировал(а) о неожиданной встрече мечты",
    task: "если партнёр делал это — коротко описывает сценарий",
  },
  {
    text: "Я никогда не отменял(а) планы ради человека, который нравится",
    task: "если партнёр делал это — признаётся, что это были за планы",
  },
  {
    text: "Я никогда не стеснялся(ась) своих чувств",
    task: "если партнёр делал это — говорит одну искреннюю фразу прямо сейчас",
  },
  {
  ...
  {
    text: "Я никогда не придумывал(а), как признаться в любви",
  ...
  {
    text: "Я никогда не думал(а): 'вот с этим человеком было бы очень спокойно'",
    task: "если партнёр делал это — говорит, что для него(неё) значит спокойствие в любви",
  },
];

function shuffle(array: typeof cards) {
  const copy = [...array];

...
function createPollQuestions(theme: string) {
  ...
  switch (theme) {
    ...
    case "Ревность":
  return [
    { id: "q1", text: "Лёгкая ревность допустима в отношениях.", options },
    { id: "q2", text: "Мне неприятно, когда партнёр слишком общается с другими.", options },
    { id: "q3", text: "Доверие должно исключать постоянные проверки.", options },
    { id: "q4", text: "Флирт с другими людьми — это нормально.", options },
    { id: "q5", text: "Я могу ревновать даже без явного повода.", options },
    { id: "q6", text: "Важно обсуждать границы в отношениях.", options },
  ];

    case "Общение":
      return [
        { id: "q1", text: "Мне важно обсуждать всё открыто, даже неприятные темы.", options },
        { id: "q2", text: "Я не люблю недосказанность в отношениях.", options },
        { id: "q3", text: "Мне важно, чтобы меня внимательно слушали.", options },
        { id: "q4", text: "Я предпочитаю говорить прямо, а не намекать.", options },
        { id: "q5", text: "Лучше обсудить проблему сразу, чем копить её.", options },
        { id: "q6", text: "Мне важно чувствовать диалог, а не монолог.", options },
      ];

    case "Любовь":
      return [
        { id: "q1", text: "Для меня важны слова любви и признания.", options },
        { id: "q2", text: "Мне важно чувствовать заботу через действия.", options },
        { id: "q3", text: "Я ценю внимание к мелочам.", options },
        { id: "q4", text: "Любовь — это ежедневные поступки, а не только чувства.", options },
        { id: "q5", text: "Мне важно чувствовать себя нужным(ой) в отношениях.", options },
        { id: "q6", text: "Мне важно, чтобы любовь проявлялась регулярно.", options },
      ];

    case "Конфликты":
      return [
        { id: "q1", text: "Я предпочитаю решать конфликты сразу.", options },
        { id: "q2", text: "Важно сохранять уважение даже в ссоре.", options },
        { id: "q3", text: "Мне важно понять причину конфликта, а не просто помириться.", options },
        { id: "q4", text: "Компромисс лучше, чем победа в споре.", options },
        { id: "q5", text: "Я не люблю, когда проблемы игнорируются.", options },
        { id: "q6", text: "После конфликта важно обсудить всё спокойно.", options },
      ];

    case "Доверие":
      return [
        { id: "q1", text: "Доверие — основа отношений.", options },
        { id: "q2", text: "Мне важно не сомневаться в партнёре.", options },
        { id: "q3", text: "Я ценю честность даже в мелочах.", options },
        { id: "q4", text: "Поступки важнее слов.", options },
        { id: "q5", text: "Мне важно чувствовать безопасность в отношениях.", options },
        { id: "q6", text: "Без доверия отношения теряют смысл.", options },
      ];

    case "Понимание":
      return [
        { id: "q1", text: "Мне важно, чтобы партнёр чувствовал моё настроение.", options },
        { id: "q2", text: "Я хочу, чтобы меня понимали без долгих объяснений.", options },
        { id: "q3", text: "Эмоциональная связь важнее логики.", options },
        { id: "q4", text: "Мне важно, чтобы мои чувства не обесценивали.", options },
        { id: "q5", text: "Я ценю эмпатию в отношениях.", options },
        { id: "q6", text: "Мне важно ощущать, что меня слышат по-настоящему.", options },
      ];

    case "Романтика":
      return [
        { id: "q1", text: "Романтика важна даже в долгих отношениях.", options },
        { id: "q2", text: "Мне нравятся неожиданные приятные сюрпризы.", options },
        { id: "q3", text: "Свидания должны быть регулярными.", options },
        { id: "q4", text: "Мне важны эмоции и атмосфера.", options },
        { id: "q5", text: "Маленькие жесты делают отношения сильнее.", options },
        { id: "q6", text: "Мне важно чувствовать страсть в отношениях.", options },
      ];

    case "Личное пространство":
      return [
        { id: "q1", text: "Мне важно время наедине с собой.", options },
        { id: "q2", text: "У каждого должны быть свои интересы.", options },
        { id: "q3", text: "Постоянно быть вместе — не обязательно.", options },
        { id: "q4", text: "Я ценю независимость в отношениях.", options },
        { id: "q5", text: "Личное пространство делает отношения здоровее.", options },
        { id: "q6", text: "Мне важно, чтобы мои границы уважали.", options },
      ];

    case "Будущее":
      return [
        { id: "q1", text: "Мне важно понимать будущее отношений.", options },
        { id: "q2", text: "Я хочу обсуждать планы заранее.", options },
        { id: "q3", text: "Общие цели важны для стабильности.", options },
        { id: "q4", text: "Мне важно двигаться в одном направлении.", options },
        { id: "q5", text: "Будущее должно быть понятным и ясным.", options },
        { id: "q6", text: "Я ценю серьёзность намерений.", options },
      ];

    case "Быт":
      return [
        { id: "q1", text: "Быт влияет на отношения сильнее, чем кажется.", options },
        { id: "q2", text: "Обязанности нужно делить честно.", options },
        { id: "q3", text: "Мне важно, чтобы дома было комфортно.", options },
        { id: "q4", text: "Чистота и порядок важны для меня.", options },
        { id: "q5", text: "Мне важно, чтобы партнёр помогал по дому.", options },
        { id: "q6", text: "Быт — это командная работа.", options },
      ];

    default:
      return [
        { id: "q1", text: "Мне важно взаимное уважение.", options },
        { id: "q2", text: "Честность важна в отношениях.", options },
        { id: "q3", text: "Поддержка делает отношения сильнее.", options },
        { id: "q4", text: "Мне важно чувствовать комфорт.", options },
      ];
  }
}

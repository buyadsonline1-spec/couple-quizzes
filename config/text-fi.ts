...
export const TEXT_FI = {
  ...
  dating: {
    introTitle: "Löydä kumppani 💘",
    introSubtitle: "Osio niille, jotka eivät ole vielä parissa. Profiileja ei näytetä satunnaisesti — ne järjestetään yhteensopivuuden mukaan, samojen testien ja kyselyiden perusteella, joita teet jo Couple Quizzesissa.",
    howItWorksTitle: "Näin se toimii",
    step1Title: "Tee testit ja kyselyt",
    step1Text: "Rakkauden kieli, luottamus ja pari muuta testiä muodostavat profiilisi",
    step2Title: "Täytä profiilisi",
    step2Text: "Kuva, nimi, ikä ja pieni kuvaus itsestäsi",
    step3Title: "Selaa ehdotuksia",
    ...
    photoHint: "Vähintään yksi kuva vaaditaan",
    nameLabel: "Nimi",
    ...
    seekingGirl: "Naista",
    seekingAny: "Ei väliä",
    personalityTitle: "Psykologinen profiili",
    personalityHint: "Muodostuu automaattisesti testituloksistasi — näkyy kaikille profiilissasi",
    personalityEmpty: "Tee testejä, niin tähän ilmestyy tageja",
    saveButton: "Tallenna profiili",
    savingButton: "Tallennetaan...",
    saveError: "Profiilin tallennus epäonnistui. Yritä uudelleen.",
    photoUploadError: "Kuvan lataus epäonnistui",
    photoUploading: "Ladataan kuvaa...",
    ...
    emptyMatchesTitle: "Ei vielä osumia",
    emptyMatchesText: "Siirry selaamaan löytääksesi ensimmäisen osumasi",
    goToSwipeButton: "Selaa profiileja",
    ...
    reportConfirmText: "Ilmoitetaanko tästä henkilöstä? Profiili piilotetaan teiltä molemmilta.",
    actionCancelButton: "Peruuta",
    blockedSuccess: "Käyttäjä estetty",
    reportedSuccess: "Ilmoitus lähetetty",
